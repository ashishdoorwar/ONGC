...
@Component(
		...
		property = {
				...
				"javax.portlet.display-name=Safety Pledge",
				"javax.portlet.init-param.template-path=/",
				"javax.portlet.init-param.view-template=/safetyPledge/view.jsp",
...
public class SafetyPledgePortlet extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		xmlBuffer.append("<pledge>");
			...
			renderRequest.setAttribute("xmlBuffer", xmlBuffer.toString());
				...
				renderRequest.setAttribute("xmlBufferCheckCPf", String.valueOf(flag));
