...
<portlet:renderURL var="viewFullLeaderBoard">
	<portlet:param name="mvcPath" value="/leadership/viewFullLeaderBoard.jsp"/>
</portlet:renderURL>
<div class="table-responsive">
		...
		<br/>
	<a href="<%= viewFullLeaderBoard %>" rel="nofollow">View Full Table..</a>
		<%
			} catch (Exception e) {
				System.out.println("Exception inside viewLeaderBoard JSP "+e);
				e.printStackTrace();
			}
			finally {
     		if(res!=null)
