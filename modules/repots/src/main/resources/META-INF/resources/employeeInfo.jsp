<%@page import="com.ongc.liferay.model.Passion"%>
...
List<Passion> userPassion= (List<Passion>) request.getAttribute("userPassion");
...
<td rowspan="4" align="center" class="valign-m"><img class="img-thumbnail" style="max-height: 150px;" src="<%= themeDisplay.getURLPortal() %>/o/blade/servletProfileRepots/imageRepots?cpfno=<%= userList.getCpfNo() %>"></td></tr>
