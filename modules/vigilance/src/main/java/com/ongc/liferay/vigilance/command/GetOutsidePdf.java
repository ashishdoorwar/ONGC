...
@Component(
	    immediate = true,
	    property = {
	        "osgi.http.whiteboard.context.path=/complaintPdf",
	        "osgi.http.whiteboard.servlet.pattern=/blade/servletComplaintPdf/*"
	    },
...
public class GetOutsidePdf extends HttpServlet{
	...
	protected void doGet(
		...
		try {
		FileInputStream in = new FileInputStream(szLable.getString("complaintFilePath").toString().trim()+request.getParameter("pdfname"));
		int content;
