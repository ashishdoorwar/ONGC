...
VigilanceAdminUser userDetail =VigilanceFactory.getAdminUserServiceInstance().getUserByEmailId(emailId);
	 ...
	 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
			  ...
			  <tbody>
			   <tr>
				...
				<td width="20%">&nbsp;<%=complaint.getComplaintNo() %></td>
		...
		<%--     <td colspan="3" >
		    ...
		    <% }%>
		     ...
		     <td colspan="3" ><p><span>
<% if(Validator.isNotNull(complaint.getAttachmentList())){ %>
...
%>
  ...
  <div class="row">
    <div class="col-md-12 text-center">
	 <button class="btn btn-primary "> <a href="<%= request.getContextPath() %>/admin/printJsp.jsp?compId=<%= complaint.getComplaintNo() %>" download target="_blank"> <span class="glyphicon glyphicon-print"></span> Print</a></button> 
	</div>
		</div>   
       </div>
   </div>
