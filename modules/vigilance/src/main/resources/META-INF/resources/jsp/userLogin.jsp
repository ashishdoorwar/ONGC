...
<body>
	...
	<header>
		...
		<portlet:renderURL var="userlogin">
								<portlet:param name="mvcRenderCommandName" value="userLogin" />
							</portlet:renderURL>
		...
		<div class="col-md-12">
		<aui:form action="${userlogin}" name="fm" method="post">
		<div class="row">
		<div class="col-md-12">
		<ul class="list-inline">
		<li class="list-inline-item"><aui:input name="username"  label="" placeholder="Enter Email Id"
									type="email" cssStyle="emailInput">
									<aui:validator name="required" />
								</aui:input></li>
		<!-- <li class="list-inline-item">
		(Select option to recieve OTP)
		<aui:input name="otp" type="hidden"></aui:input>
								<div class="d-flex">
								<aui:input type="radio" label=""  name="group1" value="email" checked="true" cssStyle=""/>Email
								<aui:input type="radio" label=""  name="group1" value="Mobile" cssStyle=""/>Mobile (<span>Get verification OTP</span>)</div></li>
			 -->					
								<liferay-portlet:resourceURL var="captchaimgurl">
									<liferay-portlet:param name="captchaAct" value="image" />
								</liferay-portlet:resourceURL></li>
		<li class="list-inline-item">
		...
		<div class="capWrap">
								...
								</liferay-portlet:resourceURL><div class="captchWithSubmit">
		...
		<li class="list-inline-item"><a href="<%=registration%>" >New user Registration</a></li>
		</ul>
		</div>
		</div>
							</aui:form>
...
<div id="bannerHome-wrapper">
	...
	<div class="lodgeCompContent-wrapper" id="skip-main-content">
		...
		<div class="aboutIntro" >
			...
			<p>ONGC's Board is chaired by Dr. Alka Mittal | Director (HR) and Chairman & Managing Director - Additional Charge of this Maharatna Company. The vigilance set up in ONGC group of companies is presently headed by CVO(Chief Vigilance Officer), Mr. Ranjan Prakash Thakur. There are 20 vigilance units, spread across the organization at various Regions, Assets, Basins and Plants. In addition to these units, CVO also looks after the vigilance set up in ONGC Videsh Limited(OVL) and ONGC Petro additions Limited(OPaL). Under the able guidance of CVO, vigilance department in ONGC constantly endeavours toward evolving best corporate practices.</p>
			</div>
			</div>
	...
	<div class="container">
		<div class="aboutWrapper">
			...
			<div class="aboutVigi">
				...
				<p class="text-center">Tel (office) : 011 - 26129006, 26129016, 26755006<br /></p>
			</div>
