...
public class FeedbackPost {
	...
	public String toString() {
		return "FeedbackPost [postId=" + postId + ", categoryId=" + categoryId + ", categId=" + categId + ", category="
				+ category + ", user=" + user + ", subject=" + subject + ", message=" + message + ", noOfReplies="
				+ noOfReplies + ", captchaVal=" + captchaVal + ", status=" + status + ", postDateText=" + postDateText
				+ ", lastUpdName=" + lastUpdName + ", auth_status=" + auth_status + ", startDate=" + startDate
				+ ", endDate=" + endDate + ", opStatus=" + opStatus + ", rvStatus=" + rvStatus + ", revertReason="
				+ revertReason + ", hrCatId=" + hrCatId + ", chiefEr=" + chiefEr + ", pageId=" + pageId + ", workdays="
				+ workdays + ", color=" + color + ", pstdate=" + pstdate + ", cmmntdate=" + cmmntdate + "]";
	}
