...
public class ProfileEditUserActionCommand extends BaseMVCActionCommand{
	...
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		File to = new File(filePath+cpfNum+file.getName().substring(file.getName().lastIndexOf(".")));
		...
		boolean updateUserProfile = userService.updateUserProfile(user);
