...
<div class="row">
	<div class="col-md-12 ">
		<aui:form action="${updateUser}" name="fm" method="post" enctype="multipart/form-data">
			<aui:fieldset-group markupView="lexicon">
				<aui:row>
					<aui:col width="50">
					<img class="rounded img-thumbnail" style="max-width:63px;"
			src="<%= themeDisplay.getURLPortal() %>/o/blade/servletProfile/imageServlet?cpfno=<%=userData.getCpfNo()%>">
				...
				<aui:row>
					<aui:col width="50">
						<aui:input label="CPF Number :" name="cpfNum" 
							value="<%=userData.getCpfNo()%>" type="text" readonly="true"/>
					</aui:col>
					<aui:col width="50">
			...
			<aui:button-row cssClass="p-2">
				...
				<a href="<%= themeDisplay.getURLPortal() %>/group/reports_en" class="btn btn-primary" >Cancel</a>
			</aui:button-row>
		</aui:form>
	</div>
</div>
