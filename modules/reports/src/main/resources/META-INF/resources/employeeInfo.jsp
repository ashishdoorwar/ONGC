...
<td rowspan="4" align="center" class="valign-m"><img class="img-thumbnail" style="max-height: 150px;" src="<%= themeDisplay.getURLPortal() %>/o/blade/servletProfile/imageServlet?cpfno=<%= userList.getCpfNo() %>"></td></tr>
