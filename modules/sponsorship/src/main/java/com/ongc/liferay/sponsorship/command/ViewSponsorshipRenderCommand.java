...
@Component(
		 ...
		 "mvc.command.name=view_sponsorship_program_model"
		 }, service = MVCRenderCommand.class
		 )
public class ViewSponsorshipRenderCommand  implements MVCRenderCommand {
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		return "/sponsorship/viewSponsorship.jsp";
	}
