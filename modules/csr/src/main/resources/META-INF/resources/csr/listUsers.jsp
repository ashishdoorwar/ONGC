...
<!-- Favicon -->
<%@page import="com.ongc.liferay.csr.model.User"%>
...
<div class="container">
	...
	<portlet:renderURL var="createUserForm">
		<portlet:param name="loginId" value="<%=loginId%>" />
		<portlet:param name="mvcPath" value="/csr/createuserForm.jsp" />
	...
	<h1>List of Users</h1>
	<div align="right">
		<a href="<%=createUserForm%>"> <span class="fa fa-plus-circle"></span>Add
		</a>
	</div>
	<div id="story">
		<div class="welcome">
 ...
 --%>
			...
			<table id="userData" class="table table-bordered table-striped">
				...
				<tr>
					...
					<td><a href="${resetPassword}"><span class="fa fa-repeat"
							title="Reset password"></span></a></td>
