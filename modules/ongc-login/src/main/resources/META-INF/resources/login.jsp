...
<div class="row">
<div class="col-md-5">
<img src="<%=request.getContextPath()%>/images/loginLogo001.png" class="logo"/>
</div>
<div class="col-md-7"><p>
<%-- <liferay-ui:journal-article groupId="<%= themeDisplay.getLayout().getGroupId() %>" articleId="44733" /> --%>
<!-- <liferay-portlet:runtime portletName="com_liferay_journal_content_web_portlet_JournalContentPortlet_INSTANCE_tlvVadqo1b4i"  /> -->
</p></div>
</div>
<div class="container-fluid login-sec">

<div class="row">
<div class="col-md-7 leftBg">
		<div class="login-box">
		<h1>Internal Portal for ONGCians</h1>
...
<div class="col-md-5 rightBg text-center d-flex  align-item-center justify-content-center">
<div class="text-center d-flex align-items-center">
<div>
<p>Thought for the day</p>
<p class="hindiText"> जो बदलता है  <br/>वही आगे बढ़ता है । </p>
</div>
</div>
</div>
</div>
</div>
<footer class="text-center mt-3">Copyright Oil and Natural Gas Corporation Limited</footer>
</div>
</body>
...
<% }else if(url.equals("http://reports.ongc.in:8081")) { %>
	<c:choose>
	<c:when test="<%= themeDisplay.isSignedIn() %>">
